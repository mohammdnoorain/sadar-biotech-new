...
function Cards() {
  return (
    <div className='cards'>
      <h1 className="mt-24 text-4xl font-bold text-blue-800 hover:text-green-500 transition-colors duration-300 sm:hover:text-green-500 transition-colors duration-300">
            Our Products
            </h1>
