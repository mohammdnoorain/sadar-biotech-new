          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 mb-16">
            ...
            <h2 className="text-3xl font-bold text-blue-600 mb-6">
              ...
              <p className="transition-transform duration-300 hover:translate-x-2">
                ...
                Above Puma Store, Floor 2, Chogm Road, Porvorim, North Goa
                403521
              </p>
              ...
              <ul className="list-inside pl-4 space-y-2">
                <li className="transition-transform duration-300 hover:translate-x-2">
                  <span className="font-semibold">Unit 1:</span> C1B/42/4 & 5
                  G.I.D.C. Estate, Nandesari, 391 340 Dist.Baroda, Gujarat India
                </li>
                <li className="transition-transform duration-300 hover:translate-x-2">
                  <span className="font-semibold">Unit 2:</span> C1B/42/6 & 7
                  G.I.DC. Estate, Nandesari, 391 349 Dist. Baroda, Gujarat,
                  India
                </li>
                <li className="transition-transform duration-300 hover:translate-x-2">
                  <span className="font-semibold">Unit 3:</span> Khasra. No.
                  245/46. Village Chhapur Sher Afganpur Bhagwanpur Haridwar-
                  247661
                </li>
              </ul>
