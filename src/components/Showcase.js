    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
      {industries.map((industry, index) => (
        <div
          ...
          style={{ maxWidth: "400px" }} // Optional inline styling for additional control
        >
          <div
          ...
          >
            <img
              src={industry.image}
              alt={industry.name}
              className="w-full h-64 object-cover transform group-hover:scale-105 transition-transform duration-300" // Increased height for proportion
            />
